...
from service_bonus.use_cases.interfaces.calculate_worked_months import month_name_to_number
...
class CalculateWorkedDays(ICalculateWorkedDays):
    ...
    def calculate(self, worked_months, worker) -> int:
        ...
        no_worked_days_semester = sum(1 for d in worker.unpaid_absences if d.month in month_numbers)
